...
const ChatPage = () => {
  ...
  const sendMessageHandler = async (receiverId) =>{
    try {
      const res = await axios.post(`https://instagramclone-mern-project.onrender.com/api/v1/message/send/${receiverId}`,{textMessage},{
        headers:{
        ...
        selectedUser ? (
          <section className="flex-1 border-l border-gray-300 flex flex-col h-full">
            ...
            <div className="flex items-center p-4 border-t border-gray-300">
              <Input type="text" value={textMessage} onChange={(e)=>settextMessage(e.target.value)} className="focus-visible:ring-transparent flex-1 mr-2" placeholder="Enter your message..." />
